...
def target_file(target_hosts, ident, output_directory, dns_server, quiet, quick, no_udp_service_scan):
...
def service_scan(target_hosts, output_directory, dns_server, quiet, quick, no_udp_service_scan, ident):
    check_directory(output_directory)

    if(valid_ip(target_hosts)):
        target_ip(target_hosts, output_directory, dns_server, quiet, quick, no_udp_service_scan, ident)
    else:
        target_file(target_hosts, output_directory, dns_server, quiet, quick, no_udp_service_scan, ident)
